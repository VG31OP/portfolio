...
const projects: Project[] = [
  ...
  //   github: "https://github.com/vg31op/Coding-Ducks",
  //   get content() {
  //     return (
  //       <div>
  ...
  //   screenshots: ["1.png"],
  //   live: "http://vrajshiroya.com",
  //   github:"https://github.com/vg31op/Portfolio",
  //   skills: {
  //     frontend: [
  //       PROJECT_SKILLS.ts,
  //       PROJECT_SKILLS.next,
  ...
  //   github:"https://github.com/vg31op/GhostChat",
  //   skills: {
  ...
  //   screenshots: ["1.png"],
  //   live: "https://vg31op.github.io/JNTUA-result-analyser-spa/#/",
  //   skills: {
  ...
  // +
  {
    id: "osint-recon-terminal",
    category: "Cybersecurity",
    title: "OSINT Recon Terminal",
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            Public intelligence interface built with modern frontend architecture.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">OSINT Recon Terminal</TypographyH3>
          <p className="font-mono mb-2">
            A comprehensive tool for open-source intelligence gathering with a dark, hacker-themed terminal UI.
          </p>
        </div>
      );
    },
  ...
  {
    id: "secure-webrtc-share",
    category: "Full Stack",
    title: "Secure WebRTC Share",
    src: "/assets/projects/placeholder.png",
    screenshots: ["placeholder.png"],
    live: "#",
    github: "https://github.com/vg31op",
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            Encrypted real-time file sharing platform using WebRTC.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Secure WebRTC Share</TypographyH3>
          <p className="font-mono mb-2">
            Share files securely in real-time with WebRTC encryption. Uncompromised privacy and speed.
          </p>
        </div>
      );
    },
  },
  {
    ...
    github: "https://github.com/vg31op",
    skills: {
      frontend: [PROJECT_SKILLS.next, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.spline, PROJECT_SKILLS.framerMotion],
      backend: [],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            Interactive 3D portfolio architecture using Three.js.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">3D Portfolio Engine</TypographyH3>
          <p className="font-mono mb-2">
            Built using Spline, Next.js, and Framer Motion to create a deeply immersive experience.
          </p>
        </div>
      );
    },
  },
  {
    ...
    github: "https://github.com/vg31op",
    skills: {
      frontend: [PROJECT_SKILLS.vue, PROJECT_SKILLS.tailwind, PROJECT_SKILLS.js],
      backend: [],
    },
    get content() {
      return (
        <div>
          <TypographyP className="font-mono">
            Motion-driven futuristic interface experiments.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Experimental UI Lab</TypographyH3>
          <p className="font-mono mb-2">
            Exploring the limits of front-end motion graphics and modern, minimal design.
          </p>
        </div>
      );
    },
