...
const CONTACT_LINKS = [
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/vraj-shiroya-70b927287",
    content: "/vraj-shiroya",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Vraj Shiroya</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Vraj, a Comp. Sci. Engineer with 1.5 year experience in Devlopment, DevOps and
